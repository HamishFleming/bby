                        ...
                        if(!empty($prev_post)){    
                            ...
                            echo '<div class="left">
                                   <div class="content_nav">
                                        <span><i class="fa fa-arrow-right"></i>'.esc_html__('previous post','ochahouse').'</span>
                                        <h5 class="title">
                                ...
                                echo '<div class="left">
                                   <div class="content_nav">
                                        <span>'.esc_html__('previous post','ochahouse').'<i class="fa fa-arrow-right"></i></span>
                                        <h5 class="title">
                            ...
                            if(!empty($next_post)){
                                   ...
                                   echo '<div class="right">
                                            ...
                                            <div class="content_nav">
                                               <span>'.esc_html__('next post','ochahouse').'<i class="fa fa-arrow-right"></i></span> 
                                               <h5 class="title">
