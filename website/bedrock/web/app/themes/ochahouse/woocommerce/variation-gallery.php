...
if ( ! function_exists( 'jws_vg_admin_html' ) ) {
	function jws_vg_admin_html( $loop, $variation_data, $variation ) {
		...
		echo '<div class="jws-variation-gallery-wrapper">';
			echo '<h4>' . esc_html__( 'Variation Image Gallery', 'ochahouse' ) . '</h4>';
			...
			echo '<a href="#" class="button jws-add-variation-gallery-image">' . esc_html__( 'Add Gallery Images', 'ochahouse' ) . '</a>';
		echo '</div>';
	}
