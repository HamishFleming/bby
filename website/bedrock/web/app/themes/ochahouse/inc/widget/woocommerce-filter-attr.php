...
class Jws_Widget_Attributes_Filter extends WC_Widget {
	...
	public function __construct() {
		...
		$this->widget_description = esc_html__( 'Shows a custom attribute in a widget which lets you narrow down the list of products when viewing product categories.', 'ochahouse' );
		$this->widget_id          = 'jws_attributes_filter';
		$this->widget_name        = esc_html__( 'Jws Attributes Filter', 'ochahouse' );
		parent::__construct();
	}
	...
	public function init_settings() {
		...
		$this->settings = array(
			'title'      => array(
				'type'  => 'text',
				'std'   => esc_html__( 'Filter by', 'ochahouse' ),
				'label' => esc_html__( 'Title', 'ochahouse' )
			),
			'attribute'  => array(
				'type'    => 'select',
				'std'     => '',
				'label'   => esc_html__( 'Attribute', 'ochahouse' ),
				'options' => $attribute_array
			),
			'query_type' => array(
				'type'    => 'select',
				'std'     => 'and',
				'label'   => esc_html__( 'Query type', 'ochahouse' ),
				'options' => array(
					'and' => esc_html__( 'AND', 'ochahouse' ),
					'or'  => esc_html__( 'OR', 'ochahouse' )
				)
			),
		);
	}
