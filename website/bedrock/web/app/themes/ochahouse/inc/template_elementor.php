	...
	class Jws_Elementor {
		...
		public static function get_header_id() {
            ...
            $page_header = (is_page()) ? get_post_meta(get_the_ID(), 'page_select_header', true) : '';
                    ...
                    }elseif((is_home()) && (isset($jws_option['select-header-archive-blog']) && !empty($jws_option['select-header-archive-blog']))) {
                                    
                    $id =  $jws_option['select-header-archive-blog'];
                                    
                    }elseif((is_404()) && (isset($jws_option['select-header-404-page']) && !empty($jws_option['select-header-404-page']))){
            
                                   $id = $jws_option['select-header-404-page'];
