...
class shade_Animation {
	...
	public function register_controls( $element, $section_id, $args ) {
		...
		if ( ( 'section' === $element->get_name() && 'section_background' === $section_id ) || ( 'column' === $element->get_name() && 'section_style' === $section_id ) ) {
			...
			$element->start_controls_section(
				...
				[
					...
					'label' =>  esc_html__( 'Shade Animation', 'ochahouse' ) , 
				]
			);
            $element->add_control(
				...
				[
					...
					'label'        =>  esc_html__( 'Enable shade Animation', 'ochahouse' ),
					'default'      => '',
            ...
            $repeater->add_control(
             ...
             $repeater->add_control(
				'shape-animation',
				[
					'label'     =>  esc_html__( 'Animation Name', 'ochahouse' ),
					'type'      => Controls_Manager::SELECT,
					'options'   => [
                        'none'   =>  esc_html__( 'None', 'ochahouse' ),
						'MoveLeft'   =>  esc_html__( 'Move Left', 'ochahouse' ),
                        'MoveRight'   =>  esc_html__( 'Move Right', 'ochahouse' ),
						'MoveTop'   =>  esc_html__( 'Move Top', 'ochahouse' ),
                        'MoveBottom'   =>  esc_html__( 'Move Bottom', 'ochahouse' ),
                        'MoveCircle'   =>  esc_html__( 'Move Circle', 'ochahouse' ),
                        'MoveCircleSmall'   =>  esc_html__( 'Circle Small', 'ochahouse' ),
                        'MoveCircle360'   =>  esc_html__( 'Move Circle 360', 'ochahouse' ),
                        'MoveZoomIn'   =>  esc_html__( 'Zoom In', 'ochahouse' ),
                        'MoveZoomOut'   =>  esc_html__( 'Zoom Out', 'ochahouse' ),  
					],
                    'selectors' => [
             ...
             $repeater->add_control(
				...
				[
					'label'     =>  esc_html__( 'Animation Timing', 'ochahouse' ),
					'type'      => Controls_Manager::SELECT,
					'options'   => [
						'linear'   =>  esc_html__( 'Linear', 'ochahouse' ),
						'ease'   =>  esc_html__( 'Ease', 'ochahouse' ),
                        'ease-in'   =>  esc_html__( 'Ease In', 'ochahouse' ),
            ...
            $repeater->add_control(
        			'shape-duration',
        			[
        				'label' =>  esc_html__( 'Animation Duration', 'ochahouse' ),
        				'type' => \Elementor\Controls_Manager::NUMBER,
        				'min' => 0,
        				'max' => 20,
        				'step' => 0.1,
            ...
            $repeater->add_control(
        			'shape-delay',
        			[
        				'label' =>  esc_html__( 'Animation Delay', 'ochahouse' ),
        				'type' => \Elementor\Controls_Manager::NUMBER,
        				'min' => 0,
        				'max' => 10,
        				'step' => 0.1,
            ...
            $repeater->add_control(
				...
				[
					'type'         => Controls_Manager::SWITCHER,
					'label'        =>  esc_html__( 'Enable Alternate', 'ochahouse' ),
					'default'      => 'yes',
					'label_on'     =>  esc_html__( 'Yes', 'ochahouse' ),
					'label_off'    =>  esc_html__( 'No', 'ochahouse' ),
					'return_value' => 'yes',
            ...
            $repeater->add_control(
				...
				[
					'type'         => Controls_Manager::SWITCHER,
					'label'        =>  esc_html__( 'Enable Infinite', 'ochahouse' ),
					'default'      => 'yes',
					'label_on'     =>  esc_html__( 'Yes', 'ochahouse' ),
					'label_off'    =>  esc_html__( 'No', 'ochahouse' ),
					'return_value' => 'yes',
            ...
            'custom_width',
            [
                'label' => esc_html__( 'Custom Width', 'ochahouse' ),
            ...
            $repeater->add_control(
				...
				[
					'type'         => Controls_Manager::SWITCHER,
					'label'        =>  esc_html__( 'Enable Position X Right', 'ochahouse' ),
					'default'      => '',
					'label_on'     =>  esc_html__( 'Yes', 'ochahouse' ),
					'label_off'    =>  esc_html__( 'No', 'ochahouse' ),
					'return_value' => 'yes',
         ...
         $repeater->add_responsive_control(
            'pos_x', [
                'label' => esc_html__('Position X (%)', 'ochahouse'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['%','px'],
                'range' => [
                    '%' => [
        ...
        $repeater->add_control(
				...
				[
					'type'         => Controls_Manager::SWITCHER,
					'label'        =>  esc_html__( 'Enable Position Y Bottom', 'ochahouse' ),
					'default'      => '',
					'label_on'     =>  esc_html__( 'Yes', 'ochahouse' ),
					'label_off'    =>  esc_html__( 'No', 'ochahouse' ),
					'return_value' => 'yes',
        ...
        $repeater->add_responsive_control(
            'pos_y',[
                'label' => esc_html__('Position Y (%)', 'ochahouse'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['%','px'],
                'range' => [
                    '%' => [
        ...
        $repeater->add_responsive_control(
         ...
         $repeater->add_responsive_control(
            'custom_opacity',
            [
                'label' => esc_html__( 'Opacity', 'ochahouse' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'max' => 1,
    	   ...
    	   $element->add_control(
    			'shade_list',
    			[
    				'label' =>  esc_html__( 'Shade List', 'ochahouse' ),
         ...
         ?>
            				<div class="shade_wrap elementor-repeater-item-<?php echo esc_attr($item['_id']); ?>">
                                <div class="shade_wrap_inner<?php echo esc_attr($alternate.$infinite); ?>">
                                    <?php 
                                       // Get image URL
		                              echo '<img src="' . $item['shade_image']['url'] . '" alt="shpare_'.$item['_id'].'">';   
                                    ?>  
                                </div>  
                            </div>
            <?php } ?>
