...
class Jws_cf7 extends Widget_Base {
	...
	protected function get_cf7_forms() {
		...
		if ( empty( $field_options ) ) {
			$field_options = array(
				'-1' => esc_html__( 'You have not added any Contact Form 7 yet.', 'ochahouse' ),
			);
		}
	...
	protected function register_general_content_controls() {
		...
		$this->start_controls_section(
			...
			$this->add_control(
				'select_form',
				[
					'label'   => esc_html__( 'Select Form', 'ochahouse' ),
					'type'    => Controls_Manager::SELECT,
					'options' => $this->get_cf7_forms(),
					'default' => '0',
					'help'    => esc_html__( 'Choose the form that you want for this page for styling', 'ochahouse' ),
				]
			);
			...
			$this->add_control(
				'cf7_style',
				[
					'label'        => esc_html__( 'Field Style', 'ochahouse' ),
					'type'         => Controls_Manager::SELECT,
					'default'      => 'box',
					'options'      => [
						'box'       => esc_html__( 'Box', 'ochahouse' ),
			...
			$this->add_control(
				'input_size',
				[
					'label'        => esc_html__( 'Field Size', 'ochahouse' ),
					'type'         => Controls_Manager::SELECT,
					'default'      => 'sm',
					'options'      => [
						'xs' => esc_html__( 'Extra Small', 'ochahouse' ),
						'sm' => esc_html__( 'Small', 'ochahouse' ),
						'md' => esc_html__( 'Medium', 'ochahouse' ),
						'lg' => esc_html__( 'Large', 'ochahouse' ),
						'xl' => esc_html__( 'Extra Large', 'ochahouse' ),
					],
			...
			$this->add_responsive_control(
				'cf7_input_padding',
				[
					'label'      => esc_html__( 'Field Padding', 'ochahouse' ),
			...
			$this->add_control(
				'cf7_input_bgcolor',
				[
					'label'     => esc_html__( 'Field Background Color', 'ochahouse' ),
			...
			$this->add_control(
				'cf7_label_color',
				[
					'label'     => esc_html__( 'Label Color', 'ochahouse' ),
					'type'      => Controls_Manager::COLOR,
					'scheme'    => [
						'type'  => Color::get_type(),
						'value' => Color::COLOR_3,
			...
			$this->add_control(
				'cf7_input_color',
				[
					'label'     => esc_html__( 'Input Text / Placeholder Color', 'ochahouse' ),
					'type'      => Controls_Manager::COLOR,
					'scheme'    => [
						'type'  => Color::get_type(),
						'value' => Color::COLOR_3,
			...
			$this->add_control(
				'input_border_style',
				[
					'label'       => esc_html__( 'Border Style', 'ochahouse' ),
					'type'        => Controls_Manager::SELECT,
					'default'     => 'solid',
					'label_block' => false,
					'options'     => [
			...
			$this->add_responsive_control(
				'input_border_size',
				[
					'label'      => esc_html__( 'Border Width', 'ochahouse' ),
					'type'       => Controls_Manager::DIMENSIONS,
					'size_units' => [ 'px' ],
					'default'    => [
						'top'    => '1',
			...
			$this->add_responsive_control(
				'cf7_border_bottom',
				[
					'label'      => esc_html__( 'Border Size', 'ochahouse' ),
			...
			$this->add_control(
				'cf7_ipborder_active',
				[
					'label'     => esc_html__( 'Border Active Color', 'ochahouse' ),
					'type'      => Controls_Manager::COLOR,
					'selectors' => [
			...
			$this->add_responsive_control(
				'cf7_input_radius',
				[
					'label'      => esc_html__( 'Rounded Corners', 'ochahouse' ),
					'type'       => Controls_Manager::DIMENSIONS,
					'size_units' => [ 'px', 'em', '%' ],
					'selectors'  => [
			...
			$this->add_responsive_control(
				'cf7_text_align',
				[
					'label'     => esc_html__( 'Field Alignment', 'ochahouse' ),
	...
	protected function register_radio_content_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Radio & Checkbox', 'ochahouse' ),
			]
		);
			...
			$this->add_control(
				'cf7_radio_check_adv',
				[
					'label'        => esc_html__( 'Override Current Style', 'ochahouse' ),
			...
			$this->add_control(
				'cf7_selected_color',
				[
					'label'     => esc_html__( 'Selected Color', 'ochahouse' ),
					'type'      => Controls_Manager::COLOR,
					'scheme'    => [
						'type'  => Color::get_type(),
						'value' => Color::COLOR_3,
			...
			$this->add_control(
				...
				[
					'label'      => esc_html__( 'Checkbox Rounded Corners', 'ochahouse' ),
					'type'       => Controls_Manager::DIMENSIONS,
					'size_units' => [ 'px', '%' ],
					'condition'  => [
						'cf7_radio_check_adv!' => '',
	...
	protected function register_textarea_content_controls() {
	   	$this->start_controls_section(
			'cf7_textarea',
			[
				'label' => esc_html__( 'Textarea', 'ochahouse' ),
			]
		);
        $this->add_responsive_control(
				'cf7_textarea_height',
	...
	protected function register_button_content_controls() {
		...
		$this->start_controls_section(
			'cf7_submit_button',
			[
				'label' => esc_html__( 'Submit Button', 'ochahouse' ),
			]
		);
			...
			$this->add_responsive_control(
				'cf7_button_align',
				[
					'label'        => esc_html__( 'Button Alignment', 'ochahouse' ),
					'type'         => Controls_Manager::CHOOSE,
					'options'      => [
						'left'    => [
							'title' => esc_html__( 'Left', 'ochahouse' ),
			...
			$this->start_controls_tabs( 'tabs_button_style' );
				...
				$this->add_control(
        			...
        			'button_type',
        			[
        				'label' => esc_html__( 'Button Background Type', 'ochahouse' ),
        				'type' => Controls_Manager::CHOOSE,
        				'options' => [
        					'classic'    => [
        						'title' => esc_html__( 'Classic', 'ochahouse' ),
        						'icon' => 'eicon-paint-brush',
        					],
        					'gradient' => [
        						'title' => esc_html__( 'Gradient', 'ochahouse' ),
        						'icon' => 'eicon-barcode',
        					],
        				],
        				'default' => '',
                ...
                $this->add_control(
        			...
        			[
        				'label' => esc_html__( 'Background Second Color', 'ochahouse' ),
        				'type' => Controls_Manager::COLOR,
        				'default' => '',
        				'selectors' => [
	...
	protected function register_error_content_controls() {
		...
		$this->start_controls_section(
			'cf7_error_field',
			[
				'label' => esc_html__( 'Success / Error Message', 'ochahouse' ),
			]
		);
			...
			$this->add_control(
				'cf7_field_message',
				[
					'label'     => esc_html__( 'Field Validation', 'ochahouse' ),
				...
				$this->add_control(
					'cf7_highlight_style',
					[
						'label'        => esc_html__( 'Message Position', 'ochahouse' ),
						'type'         => Controls_Manager::SELECT,
						'default'      => 'default',
						'options'      => [
							'default'      => esc_html__( 'Default', 'ochahouse' ),
							'tooltip' => esc_html__( 'Tooltip', 'ochahouse' ),
						],
				...
				$this->add_control(
					...
					[
						'label'     => esc_html__( 'Message Color', 'ochahouse' ),
						'type'      => Controls_Manager::COLOR,
						'default'   => '#ffffff',
						'condition' => [
				...
				$this->add_control(
					'cf7_message_bgcolor',
					[
						'label'     => esc_html__( 'Message Background Color', 'ochahouse' ),
						'type'      => Controls_Manager::COLOR,
				...
				$this->add_control(
					...
					[
						'label'        => esc_html__( 'Highlight Borders', 'ochahouse' ),
						'type'         => Controls_Manager::SWITCHER,
						'label_on'     => esc_html__( 'Yes', 'ochahouse' ),
						'label_off'    => esc_html__( 'No', 'ochahouse' ),
						'return_value' => 'yes',
				...
				$this->add_control(
					...
					[
						'label'     => esc_html__( 'Highlight Border Color', 'ochahouse' ),
						'type'      => Controls_Manager::COLOR,
						'default'   => '#ff0000',
						'condition' => [
			...
			$this->add_control(
				...
				[
					'label'     => esc_html__( 'Form Success / Error Validation', 'ochahouse' ),
					'type'      => Controls_Manager::HEADING,
					'separator' => 'before',
				]
			);
				...
				$this->add_control(
					...
					[
						'label'     => esc_html__( 'Success Message Color', 'ochahouse' ),
						'type'      => Controls_Manager::COLOR,
						'default'   => '',
						'selectors' => [
				...
				$this->add_control(
					...
					[
						'label'     => esc_html__( 'Success Message Background Color', 'ochahouse' ),
						'type'      => Controls_Manager::COLOR,
						'default'   => '',
						'selectors' => [
				...
				$this->add_control(
					...
					[
						'label'     => esc_html__( 'Success Border Color', 'ochahouse' ),
						'type'      => Controls_Manager::COLOR,
						'default'   => '#008000',
						'condition' => [
				...
				$this->add_control(
					...
					[
						'label'     => esc_html__( 'Error Message Color', 'ochahouse' ),
						'type'      => Controls_Manager::COLOR,
						'default'   => '',
						'selectors' => [
				...
				$this->add_control(
					...
					[
						'label'     => esc_html__( 'Error Message Background Color', 'ochahouse' ),
						'type'      => Controls_Manager::COLOR,
						'default'   => '',
						'selectors' => [
				...
				$this->add_control(
					...
					[
						'label'     => esc_html__( 'Error Border Color', 'ochahouse' ),
						'type'      => Controls_Manager::COLOR,
						'default'   => '#ff0000',
						'condition' => [
							'cf7_valid_border_size!' => '',
				...
				$this->add_responsive_control(
					...
					[
						'label'      => esc_html__( 'Message Padding', 'ochahouse' ),
						'type'       => Controls_Manager::DIMENSIONS,
						'size_units' => [ 'px', 'em', '%' ],
						'selectors'  => [
                ...
                $this->add_responsive_control(
					...
					[
						'label'      => esc_html__( 'Message Margin', 'ochahouse' ),
						'type'       => Controls_Manager::DIMENSIONS,
						'size_units' => [ 'px', 'em', '%' ],
						'selectors'  => [
	...
	protected function register_input_style_controls() {
		...
		$this->start_controls_section(
			...
			$this->add_responsive_control(
				...
				[
					'label'      => esc_html__( 'Between Label & Input', 'ochahouse' ),
					'type'       => Controls_Manager::SLIDER,
					'size_units' => [ 'px', 'em', 'rem' ],
					'range'      => [
						'px' => [
			...
			$this->add_responsive_control(
				...
				[
					'label'      => esc_html__( 'Between Fields', 'ochahouse' ),
					'type'       => Controls_Manager::SLIDER,
					'size_units' => [ 'px', 'em', 'rem' ],
					'range'      => [
						'px' => [
	...
	protected function register_typography_style_controls() {
		...
		$this->start_controls_section(
			...
			$this->add_control(
				'cf7_label_typo',
				[
					'label'     => esc_html__( 'Form Label', 'ochahouse' ),
					'type'      => Controls_Manager::HEADING,
					'separator' => 'before',
				]
			);
			...
			$this->add_control(
				'cf7_input_typo',
				[
					'label'     => esc_html__( 'Input Text / Placeholder', 'ochahouse' ),
					'type'      => Controls_Manager::HEADING,
					'separator' => 'before',
				]
			);
			...
			$this->add_control(
				...
				[
					'label'     => esc_html__( 'Radio Button & Checkbox', 'ochahouse' ),
					'type'      => Controls_Manager::HEADING,
					'separator' => 'before',
					'condition' => [
						'cf7_radio_check_adv!' => '',
	...
	protected function register_helpful_information() {
			...
			$this->add_control(
				...
				[
					...
					'raw'             => sprintf( esc_html__( '%1$s Getting started video » %2$s', 'ochahouse' ), '<a href="https://www.youtube.com/watch?v=qhFfKf2R-SM&list=PL1kzJGWGPrW_7HabOZHb6z88t_S8r-xAc&index=8" target="_blank" rel="noopener">', '</a>' ),
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %1$s Doc Link */
					'raw'             => sprintf( esc_html__( '%1$s Display input fields in column » %2$s', 'ochahouse' ), '<a href="https://jwsementor.com/docs/how-to-set-multiple-column-fields-in-contact-form-7-styler-of-jws/?utm_source=ochahouse-dashboard&utm_medium=jws-editor-screen&utm_campaign=ochahouse-plugin" target="_blank" rel="noopener">', '</a>' ),
					'content_classes' => 'jws-editor-doc',
				]
			);
			...
			$this->add_control(
				...
				[
					'type'            => Controls_Manager::RAW_HTML,
					/* translators: %1$s Doc Link */
					'raw'             => sprintf( esc_html__( '%1$s Unable to see Checkbox / Radio / Acceptance control » %2$s', 'ochahouse' ), '<a href="https://jwsementor.com/docs/unable-to-style-checkbox-radio-buttons-acceptance-control-using-contact-form-7-styler-of-jws/?utm_source=ochahouse-dashboard&utm_medium=jws-editor-screen&utm_campaign=ochahouse-plugin" target="_blank" rel="noopener">', '</a>' ),
					'content_classes' => 'jws-editor-doc',
				]
			);
	...
	protected function render() {
		...
		$forms              = get_posts( $args );
		$field_options['0'] = esc_html__( 'select', 'ochahouse' );
		if ( $forms ) {
			foreach ( $forms as $form ) {
				$field_options[ $form->ID ] = $form->post_title;
			}
		...
		if ( ! empty( $forms ) && ! isset( $forms[-1] ) ) {
			if ( '0' === $settings['select_form'] ) {
				$html = esc_html__( 'Please select a Contact Form 7.', 'ochahouse' );
			} else {
				?>
			...
			$html = esc_html__( 'You have not added any Contact Form 7 yet.', 'ochahouse' );
		}
