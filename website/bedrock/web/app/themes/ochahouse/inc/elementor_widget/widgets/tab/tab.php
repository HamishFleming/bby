...
class Jws_tab extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Jws Tab', 'ochahouse' );
	}
	...
	protected function register_controls() {
        ...
        $this->add_control(
			...
			[
				...
				'options' => [
                    ...
                    'left'  => esc_html__( 'Left', 'ochahouse' ),
                    'right'  => esc_html__( 'Right', 'ochahouse' ),
				],
			]
		);
	    $this->add_control(
        ...
        $repeater->add_control(
			...
			[
				...
				'default' => 'template',
				'options' => [
					'template'  => esc_html__( 'Template', 'ochahouse' ),
		...
		$repeater->add_control(
				'select_template',
				[
					'label'     => esc_html__( 'Select Template', 'ochahouse' ),
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					[
						'list_title' => esc_html__( 'Nav #1', 'ochahouse' ),
					],
				],
        ...
        $this->start_controls_section(
			'nav_style',
			[
				'label' => esc_html__( 'Nav', 'ochahouse' ),
        ...
        $this->add_control(
			'absolute',
			[
				'label' => esc_html__( 'Tab Position Absolute', 'ochahouse' ),
        ...
        $this->add_control(
				'vertical',
				[
					'label' 		=> esc_html__( 'Vertical Orientation', 'ochahouse' ),
        ...
        $this->add_control(
				'horizontal',
				[
					'label' 		=> esc_html__( 'Horizontal Orientation', 'ochahouse' ),
					'type' 			=> Controls_Manager::SLIDER,
                    'size_units' => [ 'px', '%' ],
					'range' => [
        					'px' => [
        ...
        $this->add_control(
			'nav_item_style',
			[
				'label' => esc_html__( 'Item', 'ochahouse' ),
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Background Color Active', 'ochahouse' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Background Magic Animation', 'ochahouse' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
        ...
        $this->add_responsive_control(
					...
					[
						'type' 			=> Controls_Manager::DIMENSIONS,
						'label' 		=> esc_html__( 'Magic Animation Radius', 'ochahouse' ),
						'size_units' 	=> [ 'px', '%' ],
						'selectors' 	=> [
        ...
        $this->add_control(
			'nav_line_style',
			[
				'label' => esc_html__( 'Line', 'ochahouse' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
