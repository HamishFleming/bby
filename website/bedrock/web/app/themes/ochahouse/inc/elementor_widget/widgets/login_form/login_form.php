...
class Login_form extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Jws Login Form', 'ochahouse' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Toggle', 'ochahouse' ),
			]
		);
        $this->add_control(
				'layout',
				[
					...
					'default'   => 'form',
					'options'   => [
						'form'   => esc_html__( 'Form', 'ochahouse' ),
						'popup'   => esc_html__( 'Popup', 'ochahouse' ),
					],
        ...
        $this->add_control(
				'icon',
				[
					'label'            => esc_html__( 'Select Icon Tigger', 'ochahouse' ),
        ...
        $this->add_control(
				'display_active',
				[
					'label'     => esc_html__( 'Display Active', 'ochahouse' ),
					'type'      => Controls_Manager::SELECT,
					'default'   => 'login',
					'options'   => [
						'login'   => esc_html__( 'Login', 'ochahouse' ),
						'signup'   => esc_html__( 'Sign Up', 'ochahouse' ),
					],
		...
		$this->add_control(
            'show_login',
            [
                'label'         => esc_html__( 'Show Login', 'ochahouse' ),
        ...
        $this->add_control(
            'show_register',
            [
                'label'         => esc_html__( 'Show Register', 'ochahouse' ),
                'type'          => Controls_Manager::SWITCHER,
                'label_on'      => esc_html__( 'Yes', 'ochahouse' ),
                'label_off'     => esc_html__( 'No', 'ochahouse' ),
                'default'   => 'yes',
        ...
        $this->add_control(
         ...
         $this->add_control(
					'form_color_remember',
					[
						'label' 	=> esc_html__( 'Form Remember Me Color', 'ochahouse' ),
         ...
         $this->add_control(
					...
					[
						'label' 	=> esc_html__( 'Form Forget Password Color', 'ochahouse' ),
						'type' 		=> Controls_Manager::COLOR,
						'default' 	=> '',
						'selectors' => [
         ...
         $this->add_control(
					...
					[
						'label' 	=> esc_html__( 'Form Forget Password Color Hover', 'ochahouse' ),
						'type' 		=> Controls_Manager::COLOR,
						'default' 	=> '',
						'selectors' => [
         ...
         $this->add_control(
					'form_color_tab',
					[
						'label' 	=> esc_html__( 'Form Tab Color', 'ochahouse' ),
						'type' 		=> Controls_Manager::COLOR,
						'default' 	=> '',
						'selectors' => [
          ...
          $this->add_control(
					'form_color_tab_link',
					[
						'label' 	=> esc_html__( 'Form Tab Link Color', 'ochahouse' ),
						'type' 		=> Controls_Manager::COLOR,
						'default' 	=> '',
						'selectors' => [
          ...
          $this->add_control(
					...
					[
						'label' 	=> esc_html__( 'Form Tab Link Color Hover', 'ochahouse' ),
						'type' 		=> Controls_Manager::COLOR,
						'default' 	=> '',
						'selectors' => [
        ...
        $this->add_control(
					...
					[
						'label' 	=> esc_html__( 'Form Color error', 'ochahouse' ),
						'type' 		=> Controls_Manager::COLOR,
						'default' 	=> '',
						'selectors' => [
        ...
        $this->add_control(
					'form_color_login_ok',
					[
						'label' 	=> esc_html__( 'Form Color success', 'ochahouse' ),
						'type' 		=> Controls_Manager::COLOR,
						'default' 	=> '',
						'selectors' => [
        ...
        $this->start_controls_section(
			'heading-style',
			[
				'label' => esc_html__( 'Heading', 'ochahouse' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
        $this->add_group_control(
        ...
        $this->start_controls_section(
			'input-style',
			[
				'label' => esc_html__( 'Input', 'ochahouse' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
        $this->add_group_control(
        ...
        $this->add_group_control(
				...
				[
					'name' 		=> 'input_border',
					'label' 	=> esc_html__( 'Input Border', 'ochahouse' ),
					'selector' 	=> '{{WRAPPER}} #jws-login-form .jws-animation form .input',
				]
		);
        $this->end_controls_section();
        $this->start_controls_section(
			'submit-style',
			[
				'label' => esc_html__( 'Submit Input', 'ochahouse' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
