...
class Offcanvas extends Widget_Base {
	...
	protected function register_general_content_controls() {
		...
		$this->add_control(
			'preview_offcanvas',
			[
				'label'        => esc_html__( 'Preview', 'ochahouse' ),
		...
		$this->add_control(
			'content_type',
			[
				'label'   => esc_html__( 'Content Type', 'ochahouse' ),
		...
		if ( ! empty( $menus ) ) {
			$this->add_control(
				'menu',
				[
					'label'        => esc_html__( 'Menu', 'ochahouse' ),
					'type'         => Controls_Manager::SELECT,
					'options'      => $menus,
					'default'      => array_keys( $menus )[0],
					'save_default' => true,
					/* translators: %s admin link */
					'description'  => sprintf( esc_html__( 'Go to the <a href="%s" target="_blank">Menus screen</a> to manage your menus.', 'ochahouse' ), admin_url( 'nav-menus.php' ) ),
					'condition'    => [
						'content_type' => 'menu',
					],
				]
			...
			$this->add_control(
				...
				[
					...
					/* translators: %s admin link */
					'raw'             => sprintf( esc_html__( '<strong>There are no menus in your site.</strong><br>Go to the <a href="%s" target="_blank">Menus screen</a> to create one.', 'ochahouse' ), admin_url( 'nav-menus.php?action=edit&menu=0' ) ),
		...
		$this->add_control(
			...
			[
				...
				'default'    => esc_html__( 'Enter content here. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.​ Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'ochahouse' ),
				'rows'       => 10,
				'show_label' => false,
				'dynamic'    => [
					'active' => true,
		...
		$this->add_control(
			'ct_saved_rows',
			[
				'label'     => esc_html__( 'Select Section', 'ochahouse' ),
				'type'      => Controls_Manager::SELECT,
		...
		$this->add_control(
			'ct_page_templates',
			[
				'label'     => esc_html__( 'Select Page', 'ochahouse' ),
				'type'      => Controls_Manager::SELECT,
		...
		$this->add_control(
			'ct_saved_modules',
			[
				'label'     => esc_html__( 'Select Widget', 'ochahouse' ),
				'type'      => Controls_Manager::SELECT,
	...
	protected function register_display_content_controls() {
		$this->start_controls_section(
			'offcanvas',
			[
				'label' => esc_html__( 'Display Settings', 'ochahouse' ),
			]
		);
        $this->add_control(
			'use_login',
			[
				'label'        => esc_html__( 'Use For Login', 'ochahouse' ),
				'type'         => Controls_Manager::SWITCHER,
				'default'      => 'no',
				'return_value' => 'yes',
				'label_off'    => esc_html__( 'No', 'ochahouse' ),
		...
		$this->add_control(
			'offcanvas_on',
			[
				'label'   => esc_html__( 'Display On', 'ochahouse' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'button',
				'options' => [
					'button'    => esc_html__( 'Button', 'ochahouse' ),
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'     => esc_html__( 'Click Me', 'ochahouse' ),
				'placeholder' => esc_html__( 'Click Me', 'ochahouse' ),
				'dynamic'     => [
					'active' => true,
				],
                'condition'   => [
        ...
        $this->add_control(
			...
			[
				'label'       => esc_html__( 'Button Text After Login', 'ochahouse' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( 'Click Me', 'ochahouse' ),
				'placeholder' => esc_html__( 'Click Me', 'ochahouse' ),
				'dynamic'     => [
        ...
        $this->add_control(
			'btn_url_after_login',
			[
				'label' => esc_html__( 'Button Url After Login', 'ochahouse' ),
				'type' => Controls_Manager::URL,
				'placeholder' => esc_html__( 'Loged Url', 'ochahouse' ),
                'dynamic'		=> [ 'active' => true ],
                'condition'   => [
					'offcanvas_on' => 'button',
                    'use_login' => 'yes',
		...
		$this->add_control(
			...
			[
				...
				'options'      => [
					...
					'floating' => esc_html__( 'Floating', 'ochahouse' ),
				],
				'condition'    => [
		...
		$this->add_responsive_control(
			...
			[
				...
				'options'   => [
					...
					'justify' => [
						'title' => esc_html__( 'Justified', 'ochahouse' ),
		...
		$this->add_responsive_control(
			...
			[
				'label'          => esc_html__( 'Floating Position', 'ochahouse' ),
		...
		$this->add_control(
				...
				[
					'label'            => esc_html__( 'Select Icon', 'ochahouse' ),
       ...
       $this->add_control(
        ...
        $this->add_responsive_control(
			'btn_icon_padding',
			[
				'label'      => esc_html__( 'Icon Padding', 'ochahouse' ),
		...
		$this->add_control(
			...
			[
				...
				'label_block' => false,
				'options'     => [
					'right' => esc_html__( 'After Text', 'ochahouse' ),
					'left'  => esc_html__( 'Before Text', 'ochahouse' ),
				],
				'conditions'  => [
					'relation' => 'and',
					'terms'    => [
		...
		$this->add_control(
			...
			[
				'label'      => esc_html__( 'Icon Spacing', 'ochahouse' ),
				'type'       => Controls_Manager::SLIDER,
				'range'      => [
					'px' => [
						'min' => 0,
		...
		$this->add_control(
			...
			[
				'label'       => esc_html__( 'Z-Index', 'ochahouse' ),
				'description' => esc_html__( 'Adjust the z-index of the floating trigger if it is not visibile on the page. Defaults is set to 999', 'ochahouse' ),
	...
	protected function register_close_controls() {
		$this->start_controls_section(
			'section_close',
			[
				'label' => esc_html__( 'Close Button', 'ochahouse' ),
			]
		);
		...
		$this->add_control(
				'new_close_icon',
				[
					'label'            => esc_html__( 'Select Close Icon', 'ochahouse' ),
					'type'             => Controls_Manager::ICONS,
					'default'          => [
						'value' => 'fa fa-times',
                		'library' => 'fa-solid',
		...
		$this->add_control(
			...
			[
				'label'      => esc_html__( 'Icon Alignment', 'ochahouse' ),
				'type'       => Controls_Manager::SELECT,
				'default'    => 'right-top',
				'options'    => [
					'left-top'  => esc_html__( 'Left Top', 'ochahouse' ),
					'right-top' => esc_html__( 'Right Top', 'ochahouse' ),
				],
				'conditions' => [
					'relation' => 'or',
					'terms'    => [
		...
		$this->add_control(
			'esc_keypress',
			[
				'label'        => esc_html__( 'Close on ESC Keypress', 'ochahouse' ),
				'type'         => Controls_Manager::SWITCHER,
				'default'      => 'no',
				'return_value' => 'yes',
				'label_off'    => esc_html__( 'No', 'ochahouse' ),
		...
		$this->add_control(
			'overlay_click',
			[
				'label'        => esc_html__( 'Close on Overlay Click', 'ochahouse' ),
				'type'         => Controls_Manager::SWITCHER,
				'default'      => 'no',
				'return_value' => 'yes',
				'label_off'    => esc_html__( 'No', 'ochahouse' ),
	...
	protected function register_button_style_controls() {
		...
		$this->add_control(
			...
			[
				'type'      => Controls_Manager::RAW_HTML,
				'raw'       => sprintf( '<p style="font-size: 11px;font-style: italic;line-height: 1.4;color: #a4afb7;">%s</p>', esc_html__( 'To see these changes please turn off the preview setting from Content Tab.', 'ochahouse' ) ),
				'condition' => [
			...
			$this->end_controls_tab();
				...
				$this->add_control(
					...
					[
						...
						'type'      => Controls_Manager::COLOR,
						'selectors' => [
							'.is-sticky .jws-offcanvas-action-wrap .elementor-button-icon i' => 'color: {{VALUE}} !important;',
							'.is-sticky .jws-offcanvas-action-wrap .elementor-button-icon svg' => 'fill: {{VALUE}} !important;',
                            '.is-sticky .jws-offcanvas-action-wrap .elementor-button-icon path' => 'fill: {{VALUE}} !important; stroke:{{VALUE}} !important;',
						],
					]
				);
	...
	protected function register_close_icon_style_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label'      => esc_html__( 'Close Icon', 'ochahouse' ),
				'tab'        => Controls_Manager::TAB_STYLE,
				'conditions' => [
					'relation' => 'or',
					'terms'    => [
	...
	protected function register_offcanvas_style_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Off - Canvas', 'ochahouse' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
	...
	protected function register_content_style_controls() {
		$this->start_controls_section(
			...
			$this->add_group_control(
				...
				[
					'name'        => 'content_border',
					'label'       => esc_html__( 'Content Border', 'ochahouse' ),
					'placeholder' => '1px',
					'default'     => '1px',
	...
	protected function register_display_offcanvas_controls() {
		...
		$this->add_responsive_control(
			'offcanvas_width',
			[
				'label'          => esc_html__( 'Width (px)', 'ochahouse' ),
				'type'           => Controls_Manager::SLIDER,
				'size_units'     => [ 'px', '%' ],
				'default'        => [
					'size' => '300',
        ...
        $this->add_responsive_control(
			'offcanvas_height',
			[
				'label'          => esc_html__( 'Height (px)', 'ochahouse' ),
				'type'           => Controls_Manager::SLIDER,
				'size_units'     => [ 'px', '%' ],
				'range'          => [
					'px' => [
		...
		$this->add_control(
			'offcanvas_type',
			[
				'label'       => esc_html__( 'Appear Effect', 'ochahouse' ),
				'type'        => Controls_Manager::SELECT,
				'default'     => 'normal',
				'label_block' => false,
				'options'     => [
					'normal' => esc_html__( 'Slide', 'ochahouse' ),
                    'fade'   => esc_html__( 'Fade', 'ochahouse' ),
				],
				'render_type' => 'template',
			]
		);
		...
		$this->add_control(
			'page_overlay',
			[
				'label'       => esc_html__( 'Overlay Color', 'ochahouse' ),
				'type'        => Controls_Manager::COLOR,
	...
	public function get_content_type() {
		$content_type = array(
			'content'              => esc_html__( 'Content', 'ochahouse' ),
			'menu'                 => esc_html__( 'Menu', 'ochahouse' ),
			'saved_rows'           => esc_html__( 'Saved Section', 'ochahouse' ),
			'saved_page_templates' => esc_html__( 'Saved Page', 'ochahouse' ),
		);

		if ( defined( 'ELEMENTOR_PRO_VERSION' ) ) {
			$content_type['saved_modules'] = esc_html__( 'Saved Widget', 'ochahouse' );
		}
		return $content_type;
	}
	...
	public function get_offcanvas_content( $settings, $node_id ) {
		...
		switch ( $content_type ) {
			...
			case 'saved_rows':
				return \Elementor\Plugin::$instance->frontend->get_builder_content_for_display( $settings['ct_saved_rows'], true );
			break;

			case 'saved_modules':
				return \Elementor\Plugin::$instance->frontend->get_builder_content_for_display( $settings['ct_saved_modules'], true  );

			case 'saved_page_templates':
				return \Elementor\Plugin::$instance->frontend->get_builder_content_for_display( $settings['ct_page_templates'], true  );
			break;
		...
		if ( 'button' === $settings['offcanvas_on'] ) {
			...
			if ( ( 'floating' === $settings['jws_display_position'] ) && $is_editor ) {
				...
				<div class="jws-builder-msg" style="text-align: center;">
					<h5><?php esc_html_e( 'Off - Canvas - ID ', 'ochahouse' ); ?><?php echo esc_attr($id); ?></h5>
					<p><?php esc_html_e( 'Click here to edit the "Off- Canvas" settings. This text will not be visible on frontend.', 'ochahouse' ); ?></p>
				</div>
	...
	public function get_saved_data( $type = 'page' ) {
		...
		$options[-1]   = esc_html__( 'Select', 'ochahouse' );
		if ( count( $saved_widgets ) ) {
			foreach ( $saved_widgets as $saved_row ) {
				$options[ $saved_row['id'] ] = $saved_row['name'];
			}
		} else {
			$options['no_template'] = esc_html__( 'It seems that, you have not saved any template yet.', 'ochahouse' );
		}
		return $options;
	}
