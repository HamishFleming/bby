...
class Account extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Jws Account Popup', 'ochahouse' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
            'show_text',
            [
                'label'         => esc_html__( 'Show Text(Name User)', 'ochahouse' ),
        ...
        $this->add_control(
			'text_position',
			[
				'label' => esc_html__( 'Text Position', 'ochahouse' ),
        ...
        $this->add_control(
			...
			[
				...
				'default' => esc_html__( 'Login / Register', 'ochahouse' ),
                'condition'	=> [
						'show_text' => 'yes',
				],
			]
        ...
        $this->add_control(
			'text_after_login',
			[
				'label' => esc_html__( 'Text After Login', 'ochahouse' ),
				'type' =>  Controls_Manager::TEXT,
				'default' => esc_html__( 'My Accounts', 'ochahouse' ),
                'condition'	=> [
						'show_text' => 'yes',
				],
			]
        ...
        $this->add_control(
			...
			[
				...
				'placeholder' => esc_html__( 'Login / Register Url', 'ochahouse' ),
                'dynamic'		=> [ 'active' => true ],
        ...
        $this->add_control(
			'ac_link_2',
			[
				'label' => esc_html__( 'My Acccount When Logged', 'ochahouse' ),
				'type' => Controls_Manager::URL,
				'placeholder' => esc_html__( 'My Account Url', 'ochahouse' ),
                'dynamic'		=> [ 'active' => true ],
        ...
        $this->start_controls_section(
			'popup_style',
			[
				'label' => esc_html__( 'Popup Style', 'ochahouse' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
        $this->add_group_control(
			...
			[
				'name' => 'background',
				'label' => esc_html__( 'Background Overlay', 'ochahouse' ),
