...
<div class="cart-head">
    ...
    <label><?php echo esc_html__('Your Cart','ochahouse'); ?><span class="count">(<?php echo esc_attr($count); ?>)</span></label>
 <?php echo bbloomer_free_shipping_cart_notice_zones(); ?>
</div>
<div class="jws-cart-panel<?php echo esc_attr($jws_cart_empty_class_attr); ?>">
...
<ul class="cart_list">
    ...
    <?php if (WC()->cart->is_empty()) : ?>
         <li class="cart_empty">
            ...
            <?php esc_html_e( 'No Products in the Cart.', 'ochahouse' ); ?>
         </li>
    <?php endif; ?>
...
<div class="jws-cart-panel-summary">
    ...
    <div class="jws-cart-panel-summary-inner">
        ...
        <p class="woocommerce-mini-cart__total total">
            <strong><?php esc_html_e( 'Subtotal', 'ochahouse' ); ?></strong>
        ...
        <p class="woocommerce-mini-cart__buttons buttons_checkout in_product">
            <a href="<?php echo esc_url( wc_get_checkout_url() ); ?>" class="button checkout wc-forward"><?php esc_html_e( 'Checkout', 'ochahouse' ); ?></a>
        </p>
        <p class="woocommerce-mini-cart__buttons buttons_cart">
            <a href="<?php echo esc_url( wc_get_cart_url() ); ?>" class="button edit-cart">
            <span class="jws_text_read">  <?php esc_html_e( 'View cart', 'ochahouse' ); ?></span>
...
function bbloomer_free_shipping_cart_notice_zones()
{
    ...
    if (isset($min_amounts) && is_array($min_amounts)) {
        ...
        if ($current < $min_amount) { 
            ...
            $html .= '<div class="jws_shipping_wap">' .esc_html__('Free shipping on all orders over ', 'ochahouse') .  wc_price($min_amount).  '</span></div>';
        } else {
            $html .= '<div class="jws_shipping_wap"><span class="fa fa-check-square"></span>' . esc_html__('Free standard delivery', 'ochahouse') . '</div>';
        }
        $html .= '</div>';
        return $html;
    }
