...
class Gradient_Button extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Jws Button', 'ochahouse' );
	}
	...
	protected function register_controls() {
        ...
        $this->add_control(
			...
			[
				...
				'default' => 'defautl',
				'options' => [
					'defautl' => esc_html__( 'Default', 'ochahouse' ),
		...
		$this->add_control(
			...
			[
				...
				'placeholder' => esc_html__( 'Click here', 'ochahouse' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => 'left',
				'options' => [
					'left' => esc_html__( 'Before', 'ochahouse' ),
					'right' => esc_html__( 'After', 'ochahouse' ),
				],
				'condition' => [
					'icon!' => '',
				],
		...
		$this->add_control(
			'button_css_id',
			[
				'label' => esc_html__( 'Button ID', 'ochahouse' ),
				'type' => Controls_Manager::TEXT,
				'default' => '',
				'title' => esc_html__( 'Add your custom id WITHOUT the Pound key. e.g: my-id', 'ochahouse' ),
				'label_block' => false,
				'description' => esc_html__( 'Please make sure the ID is unique and not used elsewhere on the page this form is displayed. This field allows <code>A-z 0-9</code> & underscore chars without spaces.', 'ochahouse' ),
				'separator' => 'before',
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Hover With Box', 'ochahouse' ),
        ...
        $this->add_group_control(
			...
			[
				...
				'label'                 => esc_html__( 'Text Shadow', 'ochahouse' ),
				'selector'              => '{{WRAPPER}} a.elementor-button, {{WRAPPER}} .elementor-button',
			]
		);
		...
		$this->add_control(
         ...
         $this->add_control(
			...
			[
				'label' => esc_html__( 'ICon Color Hover', 'ochahouse' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			'hover_animation',
			[
				'label' => esc_html__( 'Hover Animation', 'ochahouse' ),
